...
object Encryptor {
  ...
  def main(args: Array[String]): Unit = {
    Try(this.parse(args)) match {
      ...
      case _ =>
        System.out.println("Usage: java -jar ./spark-etl-framework-1.0.jar com.it21learning.Encryptor --key-string key-value --data data-value")
        System.out.println("Usage: java -jar ./spark-etl-framework-1.0.jar com.it21learning.Encryptor --key-file file-name --data data-value")
    }
  }
